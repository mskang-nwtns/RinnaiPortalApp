...
public class SimpleSpinnerAdapter extends BaseAdapter implements android.widget.SpinnerAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = convertView;
        String optionName = list.get(position);
        ...
        viewHolder.codeName.setText(optionName);
