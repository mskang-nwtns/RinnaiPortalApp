...
/**
 * Agency Operating System(양판점 판매사원) 메인 화면
 */
public class SalespersonManagerActivity extends BaseFragmentActivity implements ViewPager.OnPageChangeListener, View.OnTouchListener{
	...
	private ImageView ivPage1, ivIcon, ivPage2;
...
//		getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE);
		...
		adapter.addFragment(new SalespersonMangerFragmentFirst(), "menu0");
		...
		helper = new MySQLiteOpenHelper(
				SalespersonManagerActivity.this,  // 현재 화면의 제어권자
		...
		ivPage2.setVisibility(View.GONE);
		btnLogout.setOnTouchListener(SalespersonManagerActivity.this);
