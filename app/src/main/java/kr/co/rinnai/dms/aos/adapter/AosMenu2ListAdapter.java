...
public class AosMenu2ListAdapter extends BaseAdapter {

	private Context context;
	private List<StockByOrderableResult> orderableList;
	...
	public AosMenu2ListAdapter() {

	}


	public AosMenu2ListAdapter(Context context, List<StockByOrderableResult> productInfoList) {
	...
	public List<StockByOrderableResult> getList() {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View v = convertView;
		StockByOrderableResult result = orderableList.get(position);
		...
		viewHolder.tvOrderStock.setText(String.format("%,d", result.getOrderStockQ()));
