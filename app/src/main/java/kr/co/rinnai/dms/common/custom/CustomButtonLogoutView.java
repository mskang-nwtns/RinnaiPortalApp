...
public class CustomButtonLogoutView extends RelativeLayout {
    ...
    public CustomButtonLogoutView(Context context) {
        super(context);
        initView();

    }

    public CustomButtonLogoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
        getAttrs(attrs);
    ...
    public CustomButtonLogoutView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initView();
    ...
    private void initView() {
        inflate(getContext(), R.layout.layout_logout, this);
        ...
        bg.setBackgroundResource(R.drawable.logout_bt_normal);
    ...
    private void setTypeArray(TypedArray typedArray) {
        ...
        symbol_resID = typedArray.getResourceId(R.styleable.CustomButton_symbol, R.drawable.logout_icon);
        symbol.setImageResource(symbol_resID);
        symbol_click_resID = typedArray.getResourceId(R.styleable.CustomButton_pressSymbol, R.drawable.logout_icon);
    ...
    public void buttonClick(boolean isTouch) {
        ...
        if(isTouch ) {
            bg.setBackgroundResource(R.drawable.logout_bt_press);
            text.setTextColor(Color.parseColor("#6a6977"));
