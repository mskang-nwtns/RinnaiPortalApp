 ...
 */
public class SalespersonActivity extends BaseFragmentActivity implements ViewPager.OnPageChangeListener, View.OnTouchListener{
...
//		getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE);
		...
		adapter.addFragment(new SalespersonFragmentFirst(), "menu0");
		...
		helper = new MySQLiteOpenHelper(
				SalespersonActivity.this,  // 현재 화면의 제어권자
		...
		btnLogout.setOnTouchListener(SalespersonActivity.this);
