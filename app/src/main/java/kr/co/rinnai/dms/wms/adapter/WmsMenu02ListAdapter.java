...
public class WmsMenu02ListAdapter extends BaseAdapter {
	...
	public WmsMenu02ListAdapter() {

	}


	public WmsMenu02ListAdapter(Context context, ArrayList<LocationInfoResult> productInfoList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tvModelCode.setVisibility(View.VISIBLE);
